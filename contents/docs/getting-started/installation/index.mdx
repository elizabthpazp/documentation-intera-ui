...
Setting up **InteraUI** is simple and flexible. You can install it via npm/yarn/pnpm/bun or clone the repository for local development. Ensure you have [Node.js](https://nodejs.org/) version 18 or higher for optimal performance.
