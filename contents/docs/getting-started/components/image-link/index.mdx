...
description: This section provides an overview of how React Components - Documentation handles links and images in Markdown.
---

In React Components - Documentation, all links and images written in Markdown are automatically converted to their respective Next.js components. This allows for better optimization and performance in your application.
