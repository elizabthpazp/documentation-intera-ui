...
| `button1`       | `string`  | Text for the primary action button inside the modal (e.g., "Sign In"). |
| `button2`       | `string`  | Text for the secondary action button (e.g., "Create Account"). |
| `input1`        | `string`  | Placeholder text for the first input field (e.g., "Email"). |
| `input2`        | `string`  | Placeholder text for the second input field (e.g., "Password"). |
...
| `hrefLink`      | `string`  | URL to navigate when clicking on a relevant link (e.g., recover password page). |
